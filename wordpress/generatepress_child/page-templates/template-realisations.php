...
<main>
      ...
      <div class="case-study__grid">
        <div class="case-study__body">
          ...
          <div class="case-study__block">
            ...
            <p>Dès la validation d'une embauche, un flux Make + IA génère le contrat pré-rempli, crée les accès, constitue le dossier d'accueil et envoie une checklist au manager.</p>
          </div>
          <div class="case-study__block">
    ...
    <div class="case-study">
      <div class="case-study__grid">
        <div class="case-study__body">
          ...
          <div class="case-study__block">
            <div class="case-study__label">La solution</div>
            <p>Connexion Qonto + comptabilité (Sage) avec pointage et détection automatique des anomalies. L'automatisation Excel des écarts alerte en cas de doublon ou d'incohérence.</p>
          </div>
    ...
    <div class="case-study">
      <div class="case-study__grid">
        <div class="case-study__body">
          ...
          <div class="case-study__block">
            <div class="case-study__label">La solution</div>
            <p>Lecture IA des emails, extraction des données clés et classement automatique dans le bon dossier, avec création de tâche de suivi.</p>
          </div>
          <div class="case-study__results">
    ...
    <div class="case-study">
      <div class="case-study__grid">
        <div class="case-study__body">
          ...
          <div class="case-study__block">
            <div class="case-study__label">La solution</div>
            <p>Le devis est généré automatiquement depuis les données du CRM, envoyé au client, puis relancé selon un calendrier fixe tant qu'aucune réponse n'est enregistrée.</p>
          </div>
          <div class="case-study__results">
  ...
  <section class="section usecase-intro">
    ...
    <div class="usecase-grid">
      <div class="usecase-card"><div class="usecase-card__sector">PME de services</div><h3>Relances clients automatisées</h3><div class="usecase-card__body"><p><span>Problème · </span>Relances manuelles, factures impayées suivies dans un tableur, retards fréquents.</p><p><span>Solution · </span>Détection des impayés et relances personnalisées envoyées automatiquement au bon moment.</p></div><div class="usecase-card__metric-row"><span class="usecase-card__metric-value">−38%</span><span class="usecase-card__metric-label">de retards de paiement</span></div></div>
