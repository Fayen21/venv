...
<main id="main">
  <section class="section" style="max-width:760px;padding-top:64px;padding-bottom:80px;">
    ...
    <div style="margin-top:32px;color:var(--text-2);font-size:16px;line-height:1.7;">
      ...
      <p>Le responsable du traitement des données collectées sur ce site est Emmanuel Brançon, entreprise individuelle, SIRET 106 501 141 00019, 650D Route de Gray, 21850 Saint-Apollinaire, contactable à <a href="mailto:emmanuel@eb-automatisation.fr">emmanuel@eb-automatisation.fr</a>.</p>
